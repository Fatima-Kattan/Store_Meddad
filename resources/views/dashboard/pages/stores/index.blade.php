...
@section('breadcrumb')
    <li class="breadcrumb-item active">@yield('breadcrumb')</li><a href="{{ route('dashboard.stores.index') }}">Stores</a>
@endsection
@section('content')
    ...
    <a href="{{ route('dashboard.stores.create') }}" class="btn">create stores</a>
        ...
        <tbody>
            @foreach ($stores as $store)
                <tr>
                    ...
                    <td>{{ $store->status }}</td>
                    <td>
                        <a href="{{ route('dashboard.stores.edit', $store->id) }}" class="btn btn_sec">Edit</a>
                    </td>
                    <td>
