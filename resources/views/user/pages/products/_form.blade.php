                        <div class="card-body">
                            ...
                            <x-form.select name="status" label="Select Product Status" :options="['active' => 'Active', 'inactive' => 'Inactive']"
                                :selected="$product->status ?? 'active'" />

                            <x-form.select name="category_id" label="Select Product Category" :options="$categories->pluck('name', 'id')->toArray()"
