...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('user.products.create') }}">create</a></li>
@endsection
...
@section('content')
    ...
    <div class="container mt-4">
        <a href="{{ route('user.products.index') }}" class="btn btn-secondary mb-3">← Back to Products</a>
